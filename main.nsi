...
;Settings
  ...
  !define APPNAME "Zl"
  !define APP_NAME_IN_INSTALLED_DIR "Zl"
  !define COMPANYNAME "Zl Inc"
  !define DESCRIPTION "A Safe software distribution company"
  !define DEVELOPER "Louai Zaiter" #License Holder
  # Files Directory
  !define FILE_DIR "/home/louai/Desktop/tes/Zl-win32-x64/" #Replace with the full path of install folder
  !define LOGO_ICON_FILE "${FILE_DIR}\logo.ico"
  !define LICENSE_TEXT_FILE "${FILE_DIR}\LICENSE.txt"
  !define SPLASH_IMG_FILE "${FILE_DIR}\zaiter.bmp"
  !define HEADER_IMG_FILE "${FILE_DIR}\zaiter.bmp"
  ...
  !define HELPURL "https://louai.zaiter"
  !define UPDATEURL "https://"
  !define ABOUTURL "https://louai.zaiter"
